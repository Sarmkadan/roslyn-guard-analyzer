...
public sealed class AnalysisFilterBuilder
{
    ...
    public AnalysisFilterBuilder MinimumSeverity(string severity)
    {
        ...
        _predicates.Add(v =>
        {
            severityOrder.TryGetValue(v.Severity.ToString(), out var level);
    ...
    /// Filters violations by specific severity level.
    /// </summary>
    public AnalysisFilterBuilder BySeverity(SeverityLevel severity)
    {
        _predicates.Add(v => v.Severity == severity);
        return this;
    }
    ...
    /// <summary>
    /// Filters violations by file path.
    /// </summary>
