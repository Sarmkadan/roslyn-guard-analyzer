...
/// <summary>
/// Provides System.Text.Json serialization and deserialization extensions for <see cref="AnalysisProject"/>.
/// </summary>
public static class AnalysisProjectJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="AnalysisProject"/> to a JSON string.
    /// </summary>
    /// <param name="value">The project to serialize.</param>
    /// <param name="indented">Whether to format the JSON with indentation for readability.</param>
    /// <returns>A JSON string representation of the project.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="value"/> is null.</exception>
    public static string ToJson(this AnalysisProject value, bool indented = false)
    {
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string to an <see cref="AnalysisProject"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    ...
    public static bool TryFromJson(string json, out AnalysisProject? value)
    {
        ...
        try
        {
            value = JsonSerializer.Deserialize<AnalysisProject>(json, _jsonSerializerOptions);
            return true;
        }
        catch (JsonException)
        {
