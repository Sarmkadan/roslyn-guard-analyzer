...
public static class AnalysisStatisticsServiceJsonExtensions
{
    ...
    /// </summary>
    private static readonly JsonSerializerOptions _jsonSerializerOptions = JsonIoHelper.CreateOptions(false);
    ...
    public static string ToJson(this AnalysisStatisticsService.ViolationStatistics value, bool indented = false)
    {
        ...
        var options = JsonIoHelper.CreateOptions(indented);
    ...
    public static AnalysisStatisticsService.ViolationStatistics? FromJson(string json)
    {
        ...
        return JsonSerializer.Deserialize<AnalysisStatisticsService.ViolationStatistics>(json, _jsonSerializerOptions);
    }
    ...
    public static bool TryFromJson(string json, out AnalysisStatisticsService.ViolationStatistics? value)
    {
        ...
        try
        {
            value = JsonSerializer.Deserialize<AnalysisStatisticsService.ViolationStatistics>(json, _jsonSerializerOptions);
